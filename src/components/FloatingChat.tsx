...
export default function FloatingChat() {
  ...
  return (
    <>
      ...
      {/* Popout Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-[400px] h-[550px] bg-white rounded-xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 bg-navy-800 text-white flex-shrink-0">
          ...
          {showSidebar && (
            <div className="flex-1 overflow-y-auto">
              <div className="p-2">
                <button
                  onClick={handleNewChat}
                  className="w-full flex items-center gap-2 px-3 py-2.5 text-sm text-navy-700 hover:bg-navy-50 rounded-lg transition-colors"
                >
